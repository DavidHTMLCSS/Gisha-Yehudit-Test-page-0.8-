...
function generateAlbumDiv(name, date, imagePath, delay, folder) {
    return `
    <div class="album" style="animation-delay: ${delay}s;" onclick="openDialog('${folder}')">
...
function generateIndexHtml(albums) {
    const albumDivs = albums.map((album, index) => {
        ...
        return generateAlbumDiv(album.name, album.date, album.imagePath, delay, album.folder);
    }).join('');
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Еврейский подход - галерея</title>
...
<body>
    ...
    <div id="context-menu" class="context-menu">
        ...
        <ul>
            ...
            <li class="social-button"><a href="https://www.instagram.com/gisha_yehudit/">
    ...
    <script>
        function openDialog(folder) {
            ...
            const images = ${JSON.stringify(albums)}.find(album => album.folder === folder).images;
